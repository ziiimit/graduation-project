    ...
    with GraphDatabase.driver(URI, auth=AUTH) as driver:
        ...
        with driver.session(database="neo4j") as session:
            ...
            resp = session.run("""
                ...
                RETURN p.text_en as paragraphText_en, a.title_en as articleTitle_en, a.title_zh as articleTitle_zh, as.title_en as ArticleSetTitle_en, as.title_zh as ArticleSetTitle_zh, t.title_en as themeTitle_en, t.title_zh as themeTitle_zh, score
